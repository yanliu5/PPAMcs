...
if(cluster==1){
	source("/data/gpfs/home/yliu23/caseoneadd/PO2_functions.txt")
...
while(jj<=tot){
	...
	while(opt <= 3){
		...
		if(class(res_200)!="try-error"&class(res_400)!="try-error"){
			...
			if(cluster==1){
				write(res_200$save1,file=paste0("PO_N200_save1_mod",opt,".txt"),append=TRUE)
				write(res_200$save2,file=paste0("PO_N200_save2_mod",opt,".txt"),append=TRUE)
				write(res_200$save3,file=paste0("PO_N200_save3_mod",opt,".txt"),append=TRUE)
				
				write(res_400$save1,file=paste0("PO_N400_save1_mod",opt,".txt"),append=TRUE)
				write(res_400$save2,file=paste0("PO_N400_save2_mod",opt,".txt"),append=TRUE)
				write(res_400$save3,file=paste0("PO_N400_save3_mod",opt,".txt"),append=TRUE)
			}
			#########################################################
